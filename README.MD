...
Configura o Kubernetes para ser obrigatorio a assinatura de dos certificados do kubelet de todos os nós.
...
Ferramenta que faz analise de vulnerabilidades em imagens
